  ...
  return (
    <div className="home">
      <header className="home-header">
        ...
        <p>Inilah tempatnya segala resep masakan enak! ResepIn Aja telah sajikan
          <br />beragam hidangan semi bergaya rumahan, tepat sebagai masakan sehari-hari.</p>
      ...
      <div className="section-info d-flex align-items-center">
        <div className="container">
          <div className="row align-items-center justify-content-center p-3 rounded ">
            ...
            <h6>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis recusandae quisquam sed sint id, possimus nihil modi voluptatibus provident a voluptatem quos cumque et quas quis, deleniti odit iste ipsa?
              ipsum dolor sit amet consectetur adipisicing elit. Nobis recusandae quisquam sed sint id, possimus nihil modi voluptatibus provident a voluptatem quos cumque et quas quis, deleniti odit iste ipsa?
           </h6>
          </div>
          <div className="col-3">
